...
<xsl:stylesheet version="1.0" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
                ...
                xmlns:j.0="http://fedora.info/definitions/v4/repository#"
                xmlns:j.1="http://www.openarchives.org/OAI/2.0/"
                xmlns:j.2="http://www.w3.org/ns/ldp#">
                ...
                <xsl:for-each select="child::*">
                    <record>
                        <header>
                            ...
                            <datestamp>
                                <xsl:value-of select="j.1:datestamp"/>
                            </datestamp>
                            <setSpec>gmd</setSpec>
                        </header>
                        <metadata>
                            <oai_dc:dc xmlns:oai_dc="http://www.openarchives.org/OAI/2.0/oai_dc/"
                                ...
                                <xsl:if test="dc:subject">
                                    <dc:subject>
                                        <xsl:value-of select="normalize-space(dc:subject)"/>
                                    </dc:subject>
                                </xsl:if>
                                ...
                                <xsl:if test="dc:coverage">
                                    <dc:coverage>
                                        <xsl:value-of select="normalize-space(dc:coverage)"/>
                                    </dc:coverage>
                                </xsl:if>
                            </oai_dc:dc>
                        </metadata>
